...
public class CreateEmployeeCommandHandler(IEmployeeCommandRepository repository) : IRequestHandler<CreateEmployeeCommand, Response<EmployeeDto>>
{
    ...
    {
        Guard.Against.Null(request.FirstName, nameof(request.FirstName));
        Guard.Against.Null(request.LastName, nameof(request.LastName));
        Guard.Against.Null(request.JobTitle, nameof(request.JobTitle));
        Guard.Against.Null(request.Department, nameof(request.Department));
        Guard.Against.Null(request.HireDate, nameof(request.HireDate));
        Guard.Against.Null(request.ContractType, nameof(request.ContractType));
        Guard.Against.Null(request.Status, nameof(request.Status));
