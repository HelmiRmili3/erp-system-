...
try {
    ...
    Write-Host "Token (first 50 chars): $($loginResponse.data.token.Substring(0,50))..."
    ...
    Write-Host "Making request with headers:"
    ...
    Write-Host "`nEmployees retrieved successfully!"
